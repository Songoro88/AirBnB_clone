#!/usr/bin/python3
"""unittests for models/place.py. Defined
...
class TestPlace_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        my_place = Place()
        my_place.id = "122456"
        my_place.created_at = my_pl.updated_at = my_date
        my_place_str = my_place.__str__()
        self.assertIn("[Place] (122456)", my_place_str)
        self.assertIn("'id': '122456'", my_place_str)
    ...
    def test_instantiation_with_kwargs(self):
        my_datt = datetime.today()
        my_date_iso = my_date.isoformat()
        my_place = Place(id="234", created_at=dt_iso, updated_at=my_date_iso)
        self.assertEqual(my_place.id, "234")
...
class TestPlace_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        my_place = Place()
        my_place.middle_name = "Songoro"
        pl.my_number = 88
        self.assertEqual("Songoro", pl.middle_name)
    ...
    def test_contrast_to_dict_dunder_dict(self):
        my_place = Place()
        self.assertNotEqual(pl.to_dict(), my_place.__dict__)
